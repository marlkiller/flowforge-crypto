                ...
                filteredNodes.map((node) => {
                  ...
                  return (
                    <DropdownMenuItem
                      ...
                      className="flex items-center gap-2 text-[11px] cursor-pointer py-1.5 px-2 group"
                    >
                      ...
                      <div className="flex flex-col min-w-0">
                        ...
                        <span className="text-[9px] text-muted-foreground truncate uppercase opacity-60">
                          {node.data.kind}
                        </span>
                      </div>
                      <MapPin className="w-3 h-3 ml-auto text-muted-foreground/0 group-hover:text-muted-foreground/50 transition-colors" />
                    </DropdownMenuItem>
                  );
                })
              )}
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-2 w-full">
                        ...
                        <span className="font-bold truncate text-destructive">
                          {node.data.label}
                        </span>
                        <MapPin className="w-3 h-3 ml-auto text-destructive/30 group-hover:text-destructive/60 transition-colors" />
                      </div>
