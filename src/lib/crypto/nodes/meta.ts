...
export const RSA_KEYGEN_META: NodeKindMeta = {
  ...
  inputs: [
    ...
    },
    {
      ...
      defaultValue: "010001",
      options: [
        { label: "0x010001 (65537)", value: "010001" },
        { label: "0x3 (3)", value: "03" },
      ],
      connectable: false,
    },
    {
...
export const RSA_META: NodeKindMeta = {
  ...
  inputs: [
    { id: "data", label: "Data", connectable: true, acceptTypes: ["raw"] },
    {
      ...
      options: [
        { label: "Key", value: "key" },
        { label: "Components (n/e/d)", value: "components" },
      ],
      connectable: false,
    },
    {
    ...
    },
    {
      ...
      connectable: true,
      acceptTypes: ["hex"],
      visible: (d) => d["keyMode"] !== "key",
      type: "text",
      placeholder: "Hex modulus n...",
    },
    {
      id: "privateExponentD",
      label: "Private Exp (d)",
      connectable: true,
      acceptTypes: ["hex"],
      visible: (d) => d["keyMode"] !== "key" && d["action"] === "decrypt",
      type: "text",
      placeholder: "Hex private exponent d...",
    },
    {
      id: "publicExponentE",
      label: "Public Exp (e)",
      connectable: true,
      acceptTypes: ["hex"],
      visible: (d) => d["keyMode"] !== "key" && d["action"] === "encrypt",
      type: "text",
      placeholder: "Hex public exponent e (default: 010001)",
    },
    {
      id: "action",
      label: "Action",
...
export const RSA_SIGN_META: NodeKindMeta = {
  ...
  inputs: [
    { id: "data", label: "Data", connectable: true, acceptTypes: ["raw"] },
    {
      ...
      options: [
        { label: "Key", value: "key" },
        { label: "Components (n/d)", value: "components" },
      ],
      connectable: false,
    },
    {
...
export const RSA_VERIFY_META: NodeKindMeta = {
  ...
  inputs: [
    ...
    },
    {
      ...
      options: [
        { label: "Key", value: "key" },
        { label: "Components (n/e)", value: "components" },
      ],
      connectable: false,
    },
    {
...
export const RSA_EXTRACT_META: NodeKindMeta = {
  kind: "rsa_extract",
  label: "Extract RSA Components",
  category: "asymmetric",
  description:
    "Parse a PEM/DER RSA key and extract modulus (n), public exponent (e), and private exponent (d) as hex strings.",
  defaultOutput: "hex",
  outputs: [
    { id: "modulusN", label: "Modulus (n)" },
    { id: "publicExponentE", label: "Public Exp (e)" },
    { id: "privateExponentD", label: "Private Exp (d)" },
  ],
  inputs: [
    {
      id: "keyData",
      label: "RSA Key (PEM/DER)",
      connectable: true,
      acceptTypes: ["pem", "base64"],
      type: "textarea",
      placeholder: "Paste RSA public or private key in PEM/DER format...",
    },
  ],
};
