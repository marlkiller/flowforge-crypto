...
export const RSA_META: NodeKindMeta = {
  ...
  inputs: [
    { id: "data", label: "Data", connectable: true, acceptTypes: ["raw"] },
    {
      ...
      visible: (d) => d["action"] !== "decrypt" && d["scheme"] !== "RAW",
      type: "textarea",
    ...
    },
    {
      ...
      connectable: true,
      acceptTypes: ["hex"],
      visible: (d) => d["scheme"] === "RAW" && d["action"] === "decrypt",
      type: "text",
    ...
    },
    {
      ...
      connectable: true,
      acceptTypes: ["hex"],
      visible: (d) => d["scheme"] === "RAW" && d["action"] === "encrypt",
      type: "text",
...
export const RSA_SIGN_META: NodeKindMeta = {
  ...
  inputs: [
    ...
    },
    {
      ...
      connectable: true,
      acceptTypes: ["hex"],
      visible: (d) => d["algorithm"] === "RAW" || d["algorithm"] === "RAW-HASH",
      type: "text",
      placeholder: "Hex modulus n...",
    },
    {
